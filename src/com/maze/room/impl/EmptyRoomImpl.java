...
public class EmptyRoomImpl implements Room {
    ...
    public EmptyRoomImpl(String name, String desrc, Content[] contents, Wall walls, Integer x, Integer y, boolean isLock, String tip) {
        this.name = name;
        this.desrc = desrc;
